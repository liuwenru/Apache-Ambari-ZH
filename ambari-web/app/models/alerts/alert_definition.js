...
App.AlertDefinition = DS.Model.extend({
  ...
  lastTriggeredForFormatted: function () {
    ...
    return triggeredFor.replace(/for/g,"状态保持").replace(/days/g,"天").replace(/hours/g,"小时").replace(/weeks/g,"周").replace(/months/g,"月").replace(/about a month ago/g,"大概一个月").replace(/about a month ago/g,"大概一个月").replace(/about a day/g,"大概一天");
  }.property('lastTriggeredRaw'),
